...
(function (R, y) {
    ...
    var pa = $ + "Delay", Ba = $ + "Duration", la = S + "Delay", Na = S + "Duration", Oa = y.$$minErr("ng"), Va = {
    ...
    y.module("ngAnimate", [], function () {
        ...
        this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$Map", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", "$$isDocumentHidden", function (b, c, e, n, z, qa, J, u, H, k, O) {
            ...
            function q(a, h, v) {
                ...
                if (H) {
                    ...
                    if (d("cancel", w, v)) if (2 === v.state) v.runner.end(); else if (v.structural) v.close(); else return U(e, v, w), v.runner; else if (d("join",
                ...
                c.$$postDigest(function () {
                    ...
                    if (c || b.counter !== z || !g) {
                        ...
                        !b.structural && f(b, !0) ? "setClass" : b.event, I(k, 2), b = qa(e, h, b.options), t.setHost(b), q(t, h, "start", {}), b.done(function (a) {
                        B(!a);
            ...
            var x = new z, ga = new z, g = null, ta = c.$watch(function () {
            ...
            }), h = Object.create(null), t = a.classNameFilter(), Xa = t ? function (a) {
                return t.test(a)
            } : function () {
                return !0
            }, D = Y(H), w = R.Node.prototype.contains || function (a) {
            ...
            return function (p, J, u) {
                    ...
                    s(a, function (a, d) {
                        ...
                        if (h.length) {
                            ...
                            s(h, function (a) {
                                ...
                                c[b] = c[b] || {};
                                c[b][e] = {animationID: d, element: E(a)}
                            })
                        } else b.push(a)
                    });
                    var d = {}, f = {};
                            ...
                            if (!f[l]) {
                                var B = f[l] = {
                                    structural: !0, beforeStart: function () {
                                        ...
                                        q.close();
                                        x.close()
                                    }, classes: O(q.classes, x.classes), from: q, to: x, anchors: []
                                };
                ...
                function O(a, b) {
                    ...
                    for (var c = [], d = 0; d < a.length; d++) {
                        var f = a[d];
                        if ("ng-" !== f.substring(0, 3)) for (var e =
                            0; e < b.length; e++) if (f === b[e]) {
                            c.push(f);
                            break
                        }
                    }
                ...
                u = na(u);
                var sa = 0 <= ["enter", "move", "leave"].indexOf(J), l = new e({
                    end: function () {
                        q()
                    }, cancel: function () {
                        q(!0)
                ...
                d.$$postDigest(function () {
                    ...
                    s(b, function (a) {
                        c.push({
                            domNode: Q(a.from ? a.from.element : a.element), fn: function () {
                                a.beforeStart();
                                var b, c = a.close;
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function (a, c, d, f, e, p, K) {
            ...
            function z(c, e, f) {
                ...
                function K() {
                    var c = G(f.attr("class") || ""), d = n(c, l), c = n(l, c), d = a(z, {to: p(f), addClass: "ng-anchor-in " + d, removeClass: "ng-anchor-out " + c, delay: !0});
                ...
                var M;
                c = function () {
                    var c = a(z, {addClass: "ng-anchor-out", delay: !0, from: p(e)});
