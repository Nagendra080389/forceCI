...
connect2Deploy.controller('deploymentController', function ($scope, $http, $location, $routeParams, $mdDialog) {
    ...
    sse = new EventSource('/api/asyncDeployments?userName=' + $scope.userName + '&repoId=' + $scope.repoId + '&branchName=' + $scope.branchName, { authorizationHeader: 'Bearer ' + $scope.connect2DeployHeaderCookie});
