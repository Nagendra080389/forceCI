...
then   
        ...
        echo ===PKGXML===
        echo Creating new destructiveChanges.xml
        ...
        do
                ...
                in
                        ...
                        *.messageChannel) TYPENAME="LightningMessageChannel";;
                        *) TYPENAME="UNKNOWN";;
                esac
                ...
                if [[ "$TYPENAME" == "UNKNOWN" && "$(basename -- "$(dirname -- "$CFILE")")" == "lwc" ]]
                then
                ...
                then
                        ...
                        then
                                ...
                                then
                                        ...
                                        C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -s "Package/types[name='$TYPENAME']" -t elem -n members -v "$ENTITY" $SCRIPTFILE
                                fi
                                #Wohack end
                        else
                                echo enity here is $ENTITY
                                echo Generating new $TYPENAME type
                                C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -s Package -t elem -n types -v "" $SCRIPTFILE
                                C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -s 'Package/types[not(*)]' -t elem -n name -v "$TYPENAME" $SCRIPTFILE
                                echo Generating new member for $ENTITY
                                C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -s "Package/types[name='$TYPENAME']" -t elem -n members -v "$ENTITY" $SCRIPTFILE
                        fi
                else
        ...
        echo Cleaning up destructiveChanges.xml
        C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -s Package -t elem -n version -v "48.0" $SCRIPTFILE
        C:/Users/nagesingh/Documents/JenkinsPOCAndProjects23Jan2020/JenkinsNew/workspace/xmlstarlet/xmlstarlet/xml.exe ed -L -i Package -t attr -n xmlns -v "http://soap.sforce.com/2006/04/metadata" $SCRIPTFILE
        echo ====FINAL DESTRUCTIVE PACKAGE.XML=====
        cat $SCRIPTFILE
else
